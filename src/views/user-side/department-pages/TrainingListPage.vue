...
<template>
    <v-layout>
        ...
        <v-parallax src="@/assets/PARALLAX.svg" height="100vh">
            <v-row>
                <v-col cols="8" style="margin-left: 300px; margin-top: 200px" class="text-center">
                    <div>
                        <div class="text-h4 mb-3 font-weight-medium" style="color: white;">
                            Training FAQs
                        </div>
                    </div>
                ...
                <v-col cols="8" style="margin: 0 auto;">
                    <v-row>
                        <v-col v-for="(faq, index) in filteredFaqs" :key="index" cols="6">
                            <v-skeleton-loader color="secondary">
            ...
            <v-dialog v-model="showDialog" max-width="500">
                <v-card>
                    ...
                    <v-card-text>
                        <li>{{ selectedFaq.answer }}</li>
                    </v-card-text>
                    <!-- <v-textarea>{{ selectedFaq.answer }}</v-textarea> -->
                    <v-card-actions>
                        <v-spacer></v-spacer>
